...
export default function ProfilePage() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        <Link to={returnPath} className="text-sm text-brand-bronze hover:underline">&larr; Back to dashboard</Link>
      </div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <section className="rounded-xl border border-brand-border bg-white p-6">
          ...
          <form className="mt-5 space-y-4" onSubmit={(event) => void handlePasswordSubmit(event)}>
            <div>
              <label className="mb-1 block text-xs font-semibold uppercase tracking-wider text-brand-muted">Current password</label>
              <input
                type="password"
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold uppercase tracking-wider text-brand-muted">New password</label>
              <input
                type="password"
                value={newPassword}
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold uppercase tracking-wider text-brand-muted">Confirm new password</label>
              <input
                type="password"
            ...
            {passwordMessage ? <p className="text-sm text-brand-teal">{passwordMessage}</p> : null}
        ...
        <section className="rounded-xl border border-brand-border bg-white p-6">
          ...
          <div className="mt-5 inline-flex rounded-lg border border-brand-border bg-brand-cream p-1">
